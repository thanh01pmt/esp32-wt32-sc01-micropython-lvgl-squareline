...
def ButtonToggleMsg_eventhandler(event_struct):
   ...
   if event == lv.EVENT.CLICKED and True:
      SetLabelProperty(ui_LabelMsg, 'Text', 'SquareLine')
   return
...
ui_LabelMsg.set_style_text_font( lv.font_montserrat_14, lv.PART.MAIN | lv.STATE.DEFAULT )
...
ui_Switch1.set_x(-197)
ui_Switch1.set_y(-136)
